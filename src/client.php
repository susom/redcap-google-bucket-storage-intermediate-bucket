...
<script>
    ...
    Client.getSignedURLAjax = "<?php echo $this->getUrl('ajax/get_signed_url.php', true, true) . '&pid=' . $this->getProjectId() ?>"
    Client.saveRecordURLAjax = "<?php echo $this->getUrl('ajax/save_record.php', true, true) . '&pid=' . $this->getProjectId() ?>"
